        ...
        sendCreateLabelRequest: function () {
            ...
            if (this.createLabelUrl) {
                ...
                this.packagesContent.childElements().each(function (pack) {
                    ...
                    ruch_tpl = pack.select('select[name="ruch_tpl"]')[0].value;
                    packagesParams[packageId] = {
                        ...
                        ruch_tpl:                   ruch_tpl,
                        ruch_serv:                  jQuery('select[name="package_ruch_type"]').val(),
                ...
                for (var packageId in this.packages) {
                    if (!isNaN(packageId)) {
                        ...
                        this.paramsCreateLabelRequest['packages[' + packageId + ']' + '[params]' + '[ruch_tpl]']               = packagesParams[packageId]['ruch_tpl'];
                        this.paramsCreateLabelRequest['packages[' + packageId + ']' + '[params]' + '[ruch_serv]']              = packagesParams[packageId]['ruch_serv'];
